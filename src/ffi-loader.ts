 ...
 */
function getLibraryNames(platform: string, arch: string): { suffixedName: string; standardName: string } {
 ...
 */
function getSuffixedLibraryName(platform: string, arch: string, extension: string): string {
